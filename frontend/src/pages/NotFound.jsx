...
export default function NotFound() {
  ...
  return (
    <AppLayout preserveLoginFrom={false}>
      <div className="min-h-full w-full px-5 sm:px-6 lg:px-8 py-8 sm:py-10 flex items-center justify-center relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -left-12 top-10 w-36 h-36 border-2 border-bauhaus-fg/10 bg-bauhaus-red/10" />
          <div className="absolute right-6 top-16 w-28 h-28 border-2 border-bauhaus-fg/10 bg-bauhaus-yellow/20" />
          <div className="absolute -right-10 bottom-8 w-40 h-40 border-2 border-bauhaus-fg/10 bg-bauhaus-blue/10" />
        </div>

        <div className="relative w-full max-w-3xl bg-bauhaus-white border-2 border-bauhaus-fg shadow-[5px_5px_0px_0px_#121212] overflow-hidden">
          ...
          <div className="p-8 sm:p-10 lg:p-12 text-center min-h-[360px] flex flex-col justify-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#FEF2F2] border border-bauhaus-red/30 text-bauhaus-red text-[10px] font-bold uppercase tracking-wider mx-auto">
            ...
            <p className="mt-3 text-sm text-[#6B7280] leading-relaxed max-w-xl mx-auto">
              The URL you entered does not match a route in this app. Use one of the actions below to continue safely.
            </p>

            <div className="mt-6 flex items-center justify-center w-full max-w-xl mx-auto px-3 py-2.5 bg-bauhaus-bg border border-[#1F2937]/20 text-xs text-bauhaus-fg/75 font-mono break-all">
              {missingPath}
            </div>
