...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-bauhaus-bg flex">
      {/* ── Left: Bauhaus decorative panel ── */}
      <div className="hidden lg:flex lg:w-1/2 bg-[#1040C0] relative overflow-hidden items-center justify-center">
        <div className="absolute inset-0">
          <div className="absolute top-[10%] left-[15%] w-64 h-64 rounded-full bg-[#F0C020] border-4 border-[#121212]" />
          <div className="absolute bottom-[15%] right-[10%] w-48 h-48 bg-[#D02020] border-4 border-[#121212] shadow-[8px_8px_0px_0px_#121212]" />
          <div className="absolute top-[60%] left-[50%] w-24 h-24 rounded-full bg-bauhaus-fg" />
          <div className="absolute top-[40%] left-0 w-full h-[2px] bg-white/20" />
          <div className="absolute top-0 left-[40%] w-[2px] h-full bg-white/20" />
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-16">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-12">
            ...
            <div className="mt-3 h-1 w-24 bg-[#D02020] mx-auto" />
          </div>

          {/* Card */}
          <div className="relative bg-white border-4 border-[#121212] shadow-[8px_8px_0px_0px_#121212] p-10">
            {/* Corner decorations */}
            <div className="absolute -top-[14px] -left-[14px] w-7 h-7 bg-[#F0C020] border-4 border-[#121212]" />
            <div className="absolute -top-[14px] -right-[14px] w-7 h-7 bg-[#D02020] border-4 border-[#121212]" />

            {/* Header */}
            <div className="flex items-center gap-4 mb-10">
              <div className="w-14 h-14 bg-[#D02020] border-2 border-[#121212] flex items-center justify-center shadow-[4px_4px_0px_0px_#121212]">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 mt-2 bg-[#D02020] border-2 border-[#121212] text-white font-bold uppercase tracking-wider shadow-[4px_4px_0px_0px_#121212] hover:shadow-[2px_2px_0px_0px_#121212] hover:translate-x-[2px] hover:translate-y-[2px] active:shadow-none active:translate-x-[4px] active:translate-y-[4px] transition-all duration-200 ease-out disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              >
                {loading ? (
          ...
          <div className="mt-8 flex justify-center gap-3">
            ...
            <div className="w-4 h-4 bg-[#F0C020] border-2 border-[#121212]" />
          </div>
        </div>
      </div>
    </div>
